  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col min-h-[80vh]">
      <div className="flex-1">
        ...
        {/* NOTA DE RODAPÉ - AVISO DE LOCALSTORAGE */}
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 flex items-start gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" className="text-yellow-600 mt-0.5 shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
          <div>
            <h4 className="text-sm font-bold text-yellow-800">Histórico Temporário</h4>
            <p className="text-xs text-yellow-700 mt-1 leading-relaxed">
              Este histórico está guardado apenas no seu dispositivo atual (telemóvel ou computador). O registo das suas encomendas desaparecerá se limpar os dados do navegador, usar o modo incógnito ou aceder através de outro aparelho. A Mercearia Orestes guarda sempre uma cópia segura da sua compra do nosso lado.
            </p>
          </div>
        </div>
      </div>
                  ...
                  return (
                    <div key={item.id} className="bg-white border border-gray-100 rounded-xl p-3 flex items-center gap-4 shadow-sm">
                      <div className="bg-gray-50 w-12 h-12 rounded-lg flex items-center justify-center overflow-hidden shrink-0 border border-gray-100">
                        ...
                        {item.product_image || item.imagem ? (
                          <img src={item.product_image || item.imagem} alt={item.product_name} className="w-full h-full object-cover" />
                        ) : '📦'}
                      </div>
