...
import { useSettings } from '../../context/public/SettingsContext'; // 1. Importar Contexto
...
export default function CartSidebar() {
  ...
  const { allowPurchases } = useSettings(); // 2. Usar variável de estado
          ...
          <div className="p-6 border-t border-gray-100 bg-gray-50 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 mt-2">
              ...
              <Link
                ...
                className={`block text-center w-full py-4 rounded-xl font-bold transition-colors shadow-sm ${
                  allowPurchases 
