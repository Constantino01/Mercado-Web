...
export default function ProdutoForm() {
  ...
  const [produto, setProduto] = useState({
    ...
    category_id: '',
    product_cost: '',
    product_description: '', // Nome correto para a API
    unit_type: 'un',
    ...
    try {
      ...
      if (isEdit) {
        ...
        setProduto({
          ...
          product_description: prodData.product_description || '', // Nome correto para a API
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        await apiCRUD.update(`/produtos/${id}`, produto);
      } else {
        await apiCRUD.create('/produtos', produto);
      }
      navigate('/private/produtos');
    } catch (error) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 space-y-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 space-y-4">
            ...
            <div>
              ...
              <textarea 
                name="product_description" // <-- CORREÇÃO AQUI
                rows="4"
                value={produto.product_description} // <-- CORREÇÃO AQUI
                onChange={handleChange}
                className="w-full border border-gray-300 rounded-xl p-3 focus:ring-1 focus:ring-green-500 focus:border-green-500 outline-none"
        ...
        {/* Coluna Lateral (Preço, Categoria) */}
