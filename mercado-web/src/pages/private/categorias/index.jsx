      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm text-gray-600">
          ...
          <tbody className="divide-y divide-gray-200">
            {loading ? (
              <tr>
                <td colSpan="4" className="px-6 py-8 text-center text-gray-500">A carregar categorias...</td>
              </tr>
              ...
              categoriasFiltradas.map((c) => (
                <tr key={c.id} className="even:bg-gray-50 hover:bg-gray-100 transition-colors">
                  ...
                  <td className="px-6 py-4 uppercase font-medium text-gray-500">{c.category_unit}</td>
